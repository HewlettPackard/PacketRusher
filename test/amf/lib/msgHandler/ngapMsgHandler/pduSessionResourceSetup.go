...
func PDUSessionResourceSetup(nasPdu []byte, ue *context.UEContext, amf context.AMFContext) ([]byte, error) {

	// message, err := buildPDUSessionResourceSetupRequest(*ue, amf, nasPdu)
	// if err != nil {
	// 	return []byte{}, err
	// }
...
func buildPDUSessionResourceSetupRequest(ue *context.UEContext, amf context.AMFContext, smContext context.SmContext, nasPdu []byte) (ngapType.NGAPPDU, error) {
	...
	transfer, err := buildPDUSessionResourceSetuprequestTransfert(smContext, amf)
	if err != nil {
...
func buildPDUSessionResourceSetuprequestTransfert(smContext context.SmContext, amf context.AMFContext) ([]byte, error) {
